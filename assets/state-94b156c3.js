import{r as g,g as j,R as V}from"./vendor-e40c3829.js";const m=e=>{let t;const n=new Set,o=(s,f)=>{const a=typeof s=="function"?s(t):s;if(!Object.is(a,t)){const i=t;t=f??(typeof a!="object"||a===null)?a:Object.assign({},t,a),n.forEach(c=>c(t,i))}},r=()=>t,E={setState:o,getState:r,getInitialState:()=>v,subscribe:s=>(n.add(s),()=>n.delete(s)),destroy:()=>{n.clear()}},v=t=e(o,r,E);return E},$=e=>e?m(e):m;var h={exports:{}},R={},w={exports:{}},O={};/**
 * @license React
